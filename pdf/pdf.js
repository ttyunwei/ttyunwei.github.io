...
;(function webpackUniversalModuleDefinition(root, factory) {
	...
	return /******/ (() => {
		...
		/******/ var __webpack_modules__ = [
			...
			/***/ (__unused_webpack_module, exports, __w_pdfjs_require__) => {
				...
				function _fetchData() {
					_fetchData = _asyncToGenerator(
						/*#__PURE__*/ _regenerator['default'].mark(function _callee(url) {
							var asTypedArray,
								response,
								_args = arguments
			...
			/***/ (module, exports, __w_pdfjs_require__) => {
				...
				;(function(global, factory) {
					;(false ? 0 : _typeof(exports)) === 'object' && 'object' !== 'undefined'
						? (module.exports = factory())
						: true
						? !((__WEBPACK_AMD_DEFINE_FACTORY__ = factory),
						  (__WEBPACK_AMD_DEFINE_RESULT__ =
								typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? __WEBPACK_AMD_DEFINE_FACTORY__.call(exports, __w_pdfjs_require__, exports, module) : __WEBPACK_AMD_DEFINE_FACTORY__),
			...
			/***/ (module, __unused_webpack_exports, __w_pdfjs_require__) => {
				...
				var NullProtoObject = function() {
					...
					NullProtoObject =
						typeof document != 'undefined' ? (document.domain && activeXDocument ? NullProtoObjectViaActiveX(activeXDocument) : NullProtoObjectViaIFrame()) : NullProtoObjectViaActiveX(activeXDocument)
					...
					function convertUnderlyingDefaultOrByteSource(source, context) {
						...
						return {
							autoAllocateChunkSize:
								autoAllocateChunkSize === undefined ? undefined : convertUnsignedLongLongWithEnforceRange(autoAllocateChunkSize, context + " has member 'autoAllocateChunkSize' that"),
												...
												while (1) {
													switch ((_context.prev = _context.next)) {
														...
														case 5:
															...
															return _context.abrupt(
																'return',
																this._fetchData(url, compressionType)['catch'](function(reason) {
					...
					_createClass(BaseStandardFontDataFactory, [
						{
							...
							value: (function() {
								var _fetch2 = _asyncToGenerator(
									/*#__PURE__*/ _regenerator['default'].mark(function _callee2(_ref4) {
										var filename, url
										return _regenerator['default'].wrap(
													...
													switch ((_context2.prev = _context2.next)) {
														...
														case 5:
															...
															return _context2.abrupt(
																'return',
																this._fetchData(url)['catch'](function(reason) {
			...
			/***/ (__unused_webpack_module, exports, __w_pdfjs_require__) => {
												...
												while (1) {
													switch ((_context.prev = _context.next)) {
														case 0:
															return _context.abrupt(
																'return',
																((_this$_transport$_htm = this._transport._htmlForXfa) === null || _this$_transport$_htm === void 0 ? void 0 : _this$_transport$_htm.children[this._pageIndex]) || null
															)
				...
				var WorkerTransport = /*#__PURE__*/ (function() {
					...
					_createClass(WorkerTransport, [
						...
						},
						{
							...
							value: function getRenderingIntent(intent, _ref16) {
								var _ref16$renderForms = _ref16.renderForms,
									renderForms = _ref16$renderForms === void 0 ? false : _ref16$renderForms,
									_ref16$includeAnnotat = _ref16.includeAnnotationStorage,
									includeAnnotationStorage = _ref16$includeAnnotat === void 0 ? false : _ref16$includeAnnotat,
									_ref16$isOpList = _ref16.isOpList,
									isOpList = _ref16$isOpList === void 0 ? false : _ref16$isOpList
						...
						},
						{
							...
							value: function setupMessageHandler() {
								...
								messageHandler.on('GetDoc', function(_ref19) {
									var pdfInfo = _ref19.pdfInfo
								...
								messageHandler.on('obj', function(data) {
									...
									switch (type) {
										case 'Image':
											...
											if (
												(imageData === null || imageData === void 0 ? void 0 : (_imageData$data = imageData.data) === null || _imageData$data === void 0 ? void 0 : _imageData$data.length) >
						...
						},
						{
							...
							value: function _onUnsupportedFeature(_ref20) {
								var featureId = _ref20.featureId
							...
							value: function saveDocument() {
								...
								return this.messageHandler
									.sendWithPromise('SaveDocument', {
										...
										filename:
											(_this$_fullReader$fil = (_this$_fullReader = this._fullReader) === null || _this$_fullReader === void 0 ? void 0 : _this$_fullReader.filename) !== null &&
											_this$_fullReader$fil !== void 0
								...
								return this.messageHandler.sendWithPromise('GetMetadata', null).then(function(results) {
									...
									return {
										...
										contentDispositionFilename:
											(_this16$_fullReader$f = (_this16$_fullReader = _this16._fullReader) === null || _this16$_fullReader === void 0 ? void 0 : _this16$_fullReader.filename) !== null &&
											_this16$_fullReader$f !== void 0
												? _this16$_fullReader$f
												: null,
										contentLength:
											(_this16$_fullReader$c = (_this16$_fullReader2 = _this16._fullReader) === null || _this16$_fullReader2 === void 0 ? void 0 : _this16$_fullReader2.contentLength) !== null &&
											_this16$_fullReader$c !== void 0
												? _this16$_fullReader$c
												: null
									}
								})
							}
				...
				var InternalRenderTask = /*#__PURE__*/ (function() {
					function InternalRenderTask(_ref21) {
						var callback = _ref21.callback,
							params = _ref21.params,
							objs = _ref21.objs,
							commonObjs = _ref21.commonObjs,
							operatorList = _ref21.operatorList,
							pageIndex = _ref21.pageIndex,
							canvasFactory = _ref21.canvasFactory,
							_ref21$useRequestAnim = _ref21.useRequestAnimationFrame,
							useRequestAnimationFrame = _ref21$useRequestAnim === void 0 ? false : _ref21$useRequestAnim,
							_ref21$pdfBug = _ref21.pdfBug,
							pdfBug = _ref21$pdfBug === void 0 ? false : _ref21$pdfBug
					...
					_createClass(
						...
						[
							...
							},
							{
								...
								value: function initializeGraphics(_ref22) {
									var _globalThis$StepperMa

									var _ref22$transparency = _ref22.transparency,
										transparency = _ref22$transparency === void 0 ? false : _ref22$transparency,
										optionalContentConfig = _ref22.optionalContentConfig
						...
						},
						{
							...
							value: (function() {
								var _bind = _asyncToGenerator(
									/*#__PURE__*/ _regenerator['default'].mark(function _callee(font) {
										var _this = this
						...
						},
						{
							...
							value: (function() {
								var _deleteStreamController2 = _asyncToGenerator(
									/*#__PURE__*/ _regenerator['default'].mark(function _callee(streamId) {
										return _regenerator['default'].wrap(
											function _callee$(_context) {
												while (1) {
													switch ((_context.prev = _context.next)) {
														case 0:
															...
															return Promise.allSettled(
																[this.streamControllers[streamId].startCall, this.streamControllers[streamId].pullCall, this.streamControllers[streamId].cancelCall].map(function(capability) {
					...
					_createClass(PDFDataTransportStream, [
						...
						},
						{
							...
							get: function get() {
								...
								return (_this$_fullRequestRea = (_this$_fullRequestRea2 = this._fullRequestReader) === null || _this$_fullRequestRea2 === void 0 ? void 0 : _this$_fullRequestRea2._loaded) !== null &&
			...
			/***/ (__unused_webpack_module, exports, __w_pdfjs_require__) => {
				...
				var LinkAnnotationElement = /*#__PURE__*/ (function(_AnnotationElement) {
					...
					function LinkAnnotationElement(parameters) {
						...
						var isRenderable = !!(
							...
							(parameters.data.actions && (parameters.data.actions.Action || parameters.data.actions['Mouse Up'] || parameters.data.actions['Mouse Down']))
						)
							...
							value: function _bindJSAction(link, data) {
								...
								var _loop = function _loop() {
									...
									link[jsName] = function() {
										...
										;(_this3$linkService$ev = _this3.linkService.eventBus) === null || _this3$linkService$ev === void 0
											? void 0
											: _this3$linkService$ev.dispatch('dispatcheventinsandbox', {
													source: _this3,
													detail: {
														id: data.id,
														name: name
							...
							value: function _setEventListener(element, baseName, eventName, valueGetter) {
								...
								if (baseName.includes('mouse')) {
									element.addEventListener(baseName, function(event) {
										...
										;(_this4$linkService$ev = _this4.linkService.eventBus) === null || _this4$linkService$ev === void 0
											? void 0
											: _this4$linkService$ev.dispatch('dispatcheventinsandbox', {
													source: _this4,
													detail: {
														id: _this4.data.id,
														name: eventName,
									...
									element.addEventListener(baseName, function(event) {
										...
										;(_this4$linkService$ev2 = _this4.linkService.eventBus) === null || _this4$linkService$ev2 === void 0
											? void 0
											: _this4$linkService$ev2.dispatch('dispatcheventinsandbox', {
													source: _this4,
													detail: {
														id: _this4.data.id,
														name: eventName,
								...
								if (this.renderInteractiveForms) {
									...
									if (this.enableScripting && this.hasJSActions) {
										...
										element.addEventListener('keydown', function(event) {
											...
											;(_this6$linkService$ev = _this6.linkService.eventBus) === null || _this6$linkService$ev === void 0
												? void 0
												: _this6$linkService$ev.dispatch('dispatcheventinsandbox', {
														source: _this6,
														detail: {
															id: id,
															name: 'Keystroke',
										...
										element.addEventListener('blur', function(event) {
											if (_this6._mouseState.isDown) {
												...
												elementData.userValue = event.target.value
												;(_this6$linkService$ev2 = _this6.linkService.eventBus) === null || _this6$linkService$ev2 === void 0
													? void 0
													: _this6$linkService$ev2.dispatch('dispatcheventinsandbox', {
															source: _this6,
															detail: {
																id: id,
																name: 'Keystroke',
										...
										if ((_this$data$actions2 = this.data.actions) !== null && _this$data$actions2 !== void 0 && _this$data$actions2.Keystroke) {
											element.addEventListener('input', function(event) {
												...
												;(_this6$linkService$ev3 = _this6.linkService.eventBus) === null || _this6$linkService$ev3 === void 0
													? void 0
													: _this6$linkService$ev3.dispatch('dispatcheventinsandbox', {
															source: _this6,
															detail: {
																id: id,
																name: 'Keystroke',
										...
										this._setEventListeners(
											element,
											[['focus', 'Focus'], ['blur', 'Blur'], ['mousedown', 'Mouse Down'], ['mouseenter', 'Mouse Enter'], ['mouseleave', 'Mouse Exit'], ['mouseup', 'Mouse Up']],
											function(event) {
							...
							value: function render() {
								...
								if (this.enableScripting && this.hasJSActions) {
									...
									selectElement.addEventListener('input', function(event) {
										...
										;(_this9$linkService$ev = _this9.linkService.eventBus) === null || _this9$linkService$ev === void 0
											? void 0
											: _this9$linkService$ev.dispatch('dispatcheventinsandbox', {
													source: _this9,
													detail: {
														id: id,
														name: 'Keystroke',
									...
									this._setEventListeners(
										selectElement,
										[['focus', 'Focus'], ['blur', 'Blur'], ['mousedown', 'Mouse Down'], ['mouseenter', 'Mouse Enter'], ['mouseleave', 'Mouse Exit'], ['mouseup', 'Mouse Up'], ['input', 'Action']],
										function(event) {
											return event.target.checked
										}
									)
				...
				var FileAttachmentAnnotationElement = /*#__PURE__*/ (function(_AnnotationElement17) {
					...
					function FileAttachmentAnnotationElement(parameters) {
						...
						;(_this13$linkService$e = _this13.linkService.eventBus) === null || _this13$linkService$e === void 0
							? void 0
							: _this13$linkService$e.dispatch('fileattachmentannotation', {
					...
					_createClass(FileAttachmentAnnotationElement, [
						...
						},
						{
							...
							value: function _download() {
								...
								;(_this$downloadManager = this.downloadManager) === null || _this$downloadManager === void 0
									? void 0
									: _this$downloadManager.openOrDownloadData(this.container, this.content, this.filename)
							}
						}
					])
						...
						_createClass(SVGGraphics, [
							...
							},
							{
								...
								value: function _makeTilingPattern(args) {
									...
									var _Util$normalizeRect = _util.Util.normalizeRect(
											[].concat(_toConsumableArray(_util.Util.applyTransform([x0, y0], matrix)), _toConsumableArray(_util.Util.applyTransform([x1, y1], matrix)))
										),
		...
		;(() => {
			...
			var pdfjsVersion = '2.11.138'
			var pdfjsBuild = 'd02233361'
			{
				if (_is_node.isNodeJS) {
